  ...
  return (
    <div>
        <div className='bg-white px-8 py-5 rounded-lg mb-8'>
            ...
            <button className='btn bg-[#2F80ED] text-white btn-sm'>Responsive</button>
        </div>

        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8'>
            {projectsData.map(project => <div className='rounded-lg bg-white p-5' key={project.id}>
                ...
                <div className='mt-6 grid gap-3 grid-cols-2'>
                    <button className='btn border-none hover:bg-black bg-[#2F80ED] text-white btn-sm'>Demo</button>
                    <button className='btn btn-outline text-[#2F80ED] border-[#2F80ED] btn-sm'>Code</button>
                </div>
            </div>)}
        </div>
    </div>
